...
def add_parts_3(grader, submission):
    ...
    grader.add_hidden_part('3b-3-hidden', t_3b_3, max_points=6, max_seconds=3, description='hidden test case with unigram costs as bigram costs and additional possible fills')
    ...
    grader.add_hidden_part('3b-4-hidden', t_3b_4, max_points=6, max_seconds=3, description='hidden test case with hand-picked bigram costs and possible fills')
